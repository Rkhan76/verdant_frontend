...
export default function EditGuardianPage() {
  return (
    <div className="w-full max-w-6xl mx-auto pb-12">
      {/* Page Header */}
      <div className="mb-6">
        <h1 className="text-[22px] font-semibold text-gray-800 tracking-tight">Guardian Edit</h1>
        <p className="text-sm text-gray-500 mt-1 flex items-center gap-2">
          ...
          <span>/</span>
          <span className="text-gray-400">Guardian Edit</span>
        </p>
      </div>
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 hover:shadow-none">
              ...
              <div className="space-y-2">
                ...
                <Input placeholder="Enter guardian name" className="h-10 border-gray-200 focus-visible:ring-[#25a194] shadow-none" defaultValue="Marvin McKinney" />
              </div>
              
              <div className="space-y-2">
                <Label className="text-sm font-semibold text-gray-700">Instagram</Label>
                <Input placeholder="Enter phone number" className="h-10 border-gray-200 focus-visible:ring-[#25a194] shadow-none" defaultValue="+1 21541214" />
              </div>

              <div className="space-y-2">
                <Label className="text-sm font-semibold text-gray-700">Occupation</Label>
                <Input placeholder="Enter occupation" className="h-10 border-gray-200 focus-visible:ring-[#25a194] shadow-none" defaultValue="N/A" />
              </div>

              <div className="space-y-2">
                <Label className="text-sm font-semibold text-gray-700">Guardian Address</Label>
                <Input placeholder="Enter guardian address" className="h-10 border-gray-200 focus-visible:ring-[#25a194] shadow-none" defaultValue="8502 Preston Rd, Inglewood, Maine 98380" />
              </div>
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input placeholder="Enter Email" type="email" className="h-10 border-gray-200 focus-visible:ring-[#25a194] shadow-none" defaultValue="marvin@example.com" />
              </div>
