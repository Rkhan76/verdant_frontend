...
const classesData = [
  { sl: '01', name: 'Class 1', section: 'A, B, C, D', status: 'Active' },
  { sl: '02', name: 'Class 2', section: 'A, B, C, D', status: 'Inactive' },
  { sl: '03', name: 'Class 3', section: 'A, B, C, D', status: 'Active' },
  { sl: '04', name: 'Class 4', section: 'A, B, C, D', status: 'Inactive' },
  { sl: '05', name: 'Class 5', section: 'A, B, C, D', status: 'Active' },
  { sl: '06', name: 'Class 6', section: 'A, B, C, D', status: 'Inactive' },
  { sl: '07', name: 'Class 7', section: 'A, B, C, D', status: 'Active' },
  { sl: '08', name: 'Class 8', section: 'A, B, C, D', status: 'Inactive' },
  { sl: '09', name: 'Class 9', section: 'A, B, C, D', status: 'Active' },
  { sl: '10', name: 'Class 10', section: 'A, B, C, D', status: 'Inactive' },
];
          ...
          <table className="w-full text-sm text-left whitespace-nowrap">
            <thead className="text-xs text-gray-800 bg-gray-50/50 uppercase font-semibold border-b border-gray-100">
              <tr>
                ...
                <th scope="col" className="px-4 py-4 min-w-[300px]">Section</th>
                <th scope="col" className="px-4 py-4 w-32">Status</th>
                <th scope="col" className="px-4 py-4 w-24 text-right">Action</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-50">
              {classesData.map((row, i) => (
                <tr key={i} className="hover:bg-gray-50/50 transition-colors">
                  <td className="px-5 py-3 text-center">
                    <input type="checkbox" className="rounded border-gray-300 text-[#25a194] focus:ring-[#25a194] h-4 w-4" />
                  </td>
                  <td className="px-4 py-4 text-gray-500">{row.sl}</td>
                  <td className="px-4 py-4 text-gray-500">{row.name}</td>
                  <td className="px-4 py-4 text-gray-500">{row.section}</td>
