...
const subjectsData = [
  { sl: '01', subject: 'English', code: '101', status: 'Active' },
  { sl: '02', subject: 'Mathematics', code: '102', status: 'Inactive' },
  { sl: '03', subject: 'Physics', code: '103', status: 'Active' },
  { sl: '04', subject: 'Chemistry', code: '104', status: 'Inactive' },
  { sl: '05', subject: 'Biology', code: '105', status: 'Active' },
  { sl: '06', subject: 'History', code: '106', status: 'Inactive' },
  { sl: '07', subject: 'Geography', code: '107', status: 'Active' },
  { sl: '08', subject: 'ICT', code: '108', status: 'Inactive' },
  { sl: '09', subject: 'Literature', code: '109', status: 'Active' },
  { sl: '10', subject: 'Business', code: '110', status: 'Inactive' },
];
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
          <h1 className="text-[22px] font-semibold text-gray-800 tracking-tight">Subjects List</h1>
          <p className="text-sm text-gray-500 mt-1 flex items-center gap-2">
            ...
            <span>/</span>
            <span className="text-gray-400">Subjects List</span>
          </p>
        </div>
          ...
          <table className="w-full text-sm text-left whitespace-nowrap">
            <thead className="text-xs text-gray-800 bg-gray-50/50 uppercase font-semibold border-b border-gray-100">
              <tr>
                ...
                <th scope="col" className="px-4 py-4 min-w-[300px]">Subject</th>
                <th scope="col" className="px-4 py-4 min-w-[200px]">Code</th>
            ...
            <tbody className="divide-y divide-gray-50">
              {subjectsData.map((row, i) => (
                <tr key={i} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-4 py-4 text-gray-500">{row.code}</td>
