...
const feesDiscountData = [
  { sl: '01', groupName: 'Class 1 (A) Fees', type: 'Percentage', value: '10%', status: 'Active' },
  { sl: '02', groupName: 'Class 2 (A) Fees', type: 'Fixed', value: '$50', status: 'Inactive' },
  { sl: '03', groupName: 'Class 3 (A) Fees', type: 'Percentage', value: '15%', status: 'Active' },
  { sl: '04', groupName: 'Class 4 (A) Fees', type: 'Fixed', value: '$75', status: 'Inactive' },
  { sl: '05', groupName: 'Class 5 (A) Fees', type: 'Percentage', value: '20%', status: 'Active' },
  { sl: '06', groupName: 'Class 6 (A) Fees', type: 'Fixed', value: '$100', status: 'Inactive' },
  { sl: '07', groupName: 'Class 7 (A) Fees', type: 'Percentage', value: '12%', status: 'Active' },
  { sl: '08', groupName: 'Class 8 (A) Fees', type: 'Fixed', value: '$60', status: 'Inactive' },
  { sl: '09', groupName: 'Class 9 (A) Fees', type: 'Percentage', value: '18%', status: 'Active' },
  { sl: '10', groupName: 'Class 10 (A) Fees', type: 'Fixed', value: '$80', status: 'Inactive' },
];
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
          <h1 className="text-[22px] font-semibold text-gray-800 tracking-tight">Fees Discount</h1>
          <p className="text-sm text-gray-500 mt-1 flex items-center gap-2">
            <Link href="/" className="hover:text-[#25a194] transition-colors">Dashboard</Link>
            <span>/</span>
            <span className="text-gray-400">Fees</span>
            <span>/</span>
            <span className="text-gray-400">Fees Discount</span>
          </p>
        </div>
          ...
          <table className="w-full text-sm text-left whitespace-nowrap">
            <thead className="text-xs text-gray-800 bg-gray-50/50 uppercase font-semibold border-b border-gray-100">
              <tr>
                ...
                <th scope="col" className="px-4 py-4 min-w-[200px]">Discount Type</th>
                <th scope="col" className="px-4 py-4 min-w-[150px]">Discount Value</th>
                <th scope="col" className="px-4 py-4 min-w-[100px]">Status</th>
                <th scope="col" className="px-4 py-4 w-20 text-center">Action</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-50">
              {feesDiscountData.map((row, idx) => (
