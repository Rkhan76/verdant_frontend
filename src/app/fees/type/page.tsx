...
const feesTypeData = [
  { sl: '01', name: 'May month fees', status: 'Active' },
  { sl: '02', name: 'Admission fees', status: 'Inactive' },
  { sl: '03', name: 'Exam fees', status: 'Active' },
  { sl: '04', name: 'April month fees', status: 'Inactive' },
  { sl: '05', name: 'March month fees', status: 'Active' },
  { sl: '06', name: 'February month fees', status: 'Inactive' },
  { sl: '07', name: 'January month fees', status: 'Active' },
  { sl: '08', name: 'Admission fees', status: 'Inactive' },
  { sl: '09', name: 'Lumpsum fees', status: 'Active' },
  { sl: '10', name: 'December Month fees', status: 'Inactive' },
];
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
          <h1 className="text-[22px] font-semibold text-gray-800 tracking-tight">Fees Type</h1>
          <p className="text-sm text-gray-500 mt-1 flex items-center gap-2">
            <Link href="/" className="hover:text-[#25a194] transition-colors">Dashboard</Link>
            <span>/</span>
            <span className="text-gray-400">Fees</span>
            <span>/</span>
            <span className="text-gray-400">Fees Type</span>
          </p>
        </div>
